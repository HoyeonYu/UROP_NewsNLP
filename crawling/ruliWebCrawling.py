...
def getRuliWebData():
    url = ['https://bbs.ruliweb.com/best/selection?orderby=readcount&range=30d&page=',
           'https://bbs.ruliweb.com/best/selection?orderby=recommend&range=30d&page=',
           'https://bbs.ruliweb.com/best/selection?orderby=replycount&range=30d&page=']
    search_page_num = 100
    title_list = []
    description_list = []

    for urlIdx in range(len(url)):
        for pageIdx in range(search_page_num):
            print(pageIdx)
            move_url = url[urlIdx] + str(pageIdx + 1)
            driver.get(move_url)
            ...
            for href in href_list:
                ...
                if check_exists_by_xpath('//*[@id="board_read"]/div/div[2]/div[1]/div[1]/div[1]/h4/span/span[2]'):
                    title = driver.find_element_by_xpath(
                        '//*[@id="board_read"]/div/div[2]/div[1]/div[1]/div[1]/h4/span/span[2]').text
